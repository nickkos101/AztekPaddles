<?php /* Template Name: Complete Race Paddle Template */ ?>
<?php get_header(); ?>
<main>
					...
					<div class="full column">
						<div class="product-cat-items complete-paddle paddle paddle-feaux">
							...
							<div class="column half">
								<p class="paddle-description">The Aztek Complete Standup Race Paddle is custom fit to you. We’ll walk you through our easy fit guide to gather your unique specifications.</p>
								<a href="<?php echo get_site_url(); ?>/get-fit" class="buy-now">Get Fit<i class="fa fa-angle-right"></i></a>
							</div>
							<div class="column half">
								<h5 class="paddle-features-title">Aztek Complete Race Paddles come with:</h5>
