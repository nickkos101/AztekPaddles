...
<main>
	<div class="white-wrap col-wrap page-content contact">
		...
		<div class="column half">
			...
			<div class="address-icon"><img src="<?php echo get_template_directory_uri(); ?>/images/address-icon.png" class="icon"></div><p class="address-par">16725 Technology Place <br />San Diego, CA 92127</p>
			<div class="map-frame">
