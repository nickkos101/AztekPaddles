                <div class="screen active">
                    <div class="column half">
                        ...
                        <p>Your unique body measurements create the perfect formula for a custom designed paddle, from shaft flex to length.</p>
                            ...
                            <div class="toolTipWrap height">
                                ...
                                <div class="toolTip">
                                    <ul>
                                        ...
                                        <li value="48">4' 8"</li>
                                        <li value="49">4' 9"</li>
                                        <li value="410">4' 10"</li>
                                        <li value="411">4' 11"</li>
                                        <li value="5">5' 0"</li>
                                        <li value="51">5' 1"</li>
                                        <li value="52">5' 2"</li>
                                        <li value="53">5' 3"</li>
                                        ...
                                        <li value="58">5' 8"</li>
                                        <li value="59">5' 9"</li>
                                        <li value="510">5' 10"</li>
                                        <li value="511">5' 11"</li>
                                        <li value="6">6' 0"</li>
                                        <li value="61">6' 1"</li>
                                        <li value="62">6' 2"</li>
                                        <li value="63">6' 3"</li>
