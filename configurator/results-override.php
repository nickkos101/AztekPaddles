                <div class="container">
                  <div class="screen results">
                    <div class="column full titlebar">
                      <div class="column half">
                        <h4>Your <b>Fit Profile</b></h4>
                      </div>
                    ...
                    <div class="column full">
                      <div class="paddle complete">
                        <div class="column fourth">
                          ...
                          <ul>
                            <li><label>Blade Type:</label> <?php selectBladeTypes(); ?></li>
                            <li><label>Blade Size:</label> <?php selectBladeSizes(); ?></li>
                            <li><label>Paddle Length (in):</label> <?php selectPaddleLength();  ?></li>
                            <li><label>Shaft Flex:</label> <?php selectFlexRating(); ?></li>
                            <li><label>Handle Size:</label> <?php selectHandleSize(); ?></li>
                          </ul>
